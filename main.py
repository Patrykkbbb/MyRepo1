...
def tries():
    ...
    parser.add_argument(
        "--max-attempts", type=int, default=5, help=("- Maksymalna cyfra to 5")
    )
    parser.add_argument(
        "--max_number", type=int, default=100, help=("- Zakres górny wynosi 100")
    )
    parser.add_argument(
        "--min_number", type=int, default=0, help=("- Zakres dolny zakres wynosi 1")
)
